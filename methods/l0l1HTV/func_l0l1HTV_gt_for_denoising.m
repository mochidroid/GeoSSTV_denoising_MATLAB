...
fprintf("** Running func_l0l1HTV_gt_for_denoising **\n");
...
gamma1_U    = gpuArray(single(1/(8*4 + 8 + 1)));
...
for i = 1:maxiter
    ...
    % Updating U
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    U_tmp   = U - gamma1_U*(Dlt(Dt(Y1)) + Dt(Y2) + Y3);
    ...
    % Updating Y2
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Y2_tmp  = Y2 + gamma2*(D(U_res));
    Y2_next = Y2_tmp - gamma2*ProjL10ball(Y2_tmp/gamma2, eps_L10ball);
    ...
    N = HSI_noisy - U - T;
    N_next = HSI_noisy - U_next - T_next;
    ...
    gamma2      = gamma2    * stepsize_reduction;
