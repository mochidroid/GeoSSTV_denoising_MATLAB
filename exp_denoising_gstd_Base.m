...
noise_conditions = { ...
    ...
    {0.1,   0.1,   0,     0,    0},     ... % g0.1 ps0.1 pt0 pd0
...
GASSTV_sigma_sp = {"90", "med"};
GASSTV_sigma_l = {"90", "med"};
GASSTV_lambda_rho_sp = [0.9, 1, 1.1, 1.2];
% GASSTV_lambda1 = [0.01];
GASSTV_lambda_rho_l = [0.9, 1, 1.1, 1.2];
% GASSTV_num_segments = [3, 5, 10];
GASSTV_num_segments = [5];
methods_info(end+1) = struct( ...
    "name", "GASSTV_GTV_Oraguide_Const", ...
    "func", @(HSI_clean, HSI_noisy, params, deg) ...
